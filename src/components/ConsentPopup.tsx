          ...
          >
            ...
            <div className="flex-1 p-6 md:p-8">
              ...
              <div className="prose prose-invert prose-sm max-w-none space-y-3 mb-6 text-gray-300">
                ...
                <p>Stripchat AI AI has a zero-tolerance policy toward human trafficking, prostitution, and any other illegal conduct. We cooperate with law enforcement in investigating criminal activity.</p>
